# Welcome to the IDSA Knowledge Base
...
* IDSA Rulebook V2.5 release (see [release notes](https://github.com/International-Data-Spaces-Association/IDSA-Rulebook/releases/tag/Rulebook_V2.5))
